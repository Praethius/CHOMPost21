...
/datum/configuration
	...
	var/static/pregame_time = 5				// pregame time in seconds
	var/static/vote_delay = 5				// minimum time between voting sessions (deciseconds, 10 minute default)
	var/static/vote_period = 5				// length of voting period (deciseconds, default 1 minute)
