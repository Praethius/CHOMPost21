...
/datum/map/outpost_holiday
	name = "Outpost 21 Holiday"
	full_name = "Holiday Apartments Near ESHUI Atmospheric Terraforming Outpost 21"
	path = "outpost_holiday"
	...
	station_name  = "ESHUI Atmospheric Terraforming Outpost 21 - Holiday"
	station_short = "Outpost 21 Holzone"
	...
	usable_email_tlds = list("holiday.internalmail.es")
	allowed_spawns = list("Apartment", "Corridor")
	...
	overmap_z = Z_LEVEL_OUTPOST_SURFACE
	map_levels = list(
			Z_LEVEL_OUTPOST_SURFACE
		)
...
/obj/effect/overmap/visitable/sector/muriki
	name = "Muriki"
	desc = "What a terrible place to call home. At least there's a little vacation zone."
